...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             MO(_FN3), _______,   KC_HOME, KC_END),
    ...
    [_FN2] = LAYOUT_60_ansi(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  KC_DEL,
        _______, _______, _______, M_EMOJ,  _______, _______, _______, M_ALFR,  _______, M_GDIFF, _______,  _______, _______, _______,
        _______, KC_LALT, KC_LSFT, KC_LGUI, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,  KC_VOLU,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, KC_F14,  KC_F15,   KC_VOLD,          _______,
        _______, _______, _______,                            _______,                            _______,  _______, _______, _______),
