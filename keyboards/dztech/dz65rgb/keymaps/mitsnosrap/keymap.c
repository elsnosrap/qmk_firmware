...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                    MO(_FN3), _______,  MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT),

    [_FN1] = LAYOUT_65_ansi(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F10,   KC_F11,   KC_F12,   _______, _______, _______,
    ...
    [_FN2] = LAYOUT_65_ansi(
        ...
        _______,          _______, _______, _______, _______, _______, _______, _______, KC_F14,   KC_F15,   _______,  _______, _______, _______,
    ...
    [_FN3] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD,  _______,  _______,           _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
        _______, _______, _______,                            _______,                   _______,  _______,  _______,  _______, _______, _______),

    [_FN_EMPTY] = LAYOUT_65_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,           _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
