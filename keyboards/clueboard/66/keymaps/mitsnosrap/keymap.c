...
[_BL] = LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, _______,          KC_SPC,  KC_SPC,                    _______, MO(_FL), KC_RCTL, MO(_FL), KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______, _______, M_ACFER, M_ACPRE, M_ACPAR, M_ALDL,  _______, _______, _______, KC_F14,  KC_F15,  _______, _______, _______, KC_VOLU,
