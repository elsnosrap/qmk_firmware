...
[_BL] = LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI,          KC_SPC,   MO(_FL),                    KC_LCTL, MO(_CL), _______, MO(_CL), KC_LEFT, KC_DOWN, KC_RGHT),
...
[_CL] = LAYOUT(
  ...
  _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, BL_TOGG,          BL_INC,           \
  _______, _______, _______,          _______,  _______,                    _______, _______, _______, _______, _______, BL_DEC,  _______),
};
