...
[_BL] = LAYOUT_65_ansi(
    ...
    KC_LSFT, KC_Z,    KC_X,    FN2_C,   KC_V,   KC_B,     FN1_N,   CTRL_M,  KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,          KC_UP,   KC_PGDN,
    KC_LCTL, KC_LALT, KC_LGUI,                KC_SPC,                       _______, _______, MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FN1] = LAYOUT_65_ansi(
    ...
    _______, M_ACFER, M_ACPRE, M_ACPAR, M_ALDL,  M_ALDP,  _______, _______, _______, KC_F14,  KC_F15,   _______,          KC_VOLU, _______,
