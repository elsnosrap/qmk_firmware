...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    _______, _______, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,     KC_7,     KC_8,    KC_9,     KC_0,    KC_MINS, KC_EQL,  _______,  KC_BSPC, KC_MUTE, \
    M_ZMUTE, M_ZVID,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,     KC_P,    KC_LBRC, KC_RBRC,           KC_BSLS, KC_DEL, \
    _______, _______, KC_GESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,     KC_J,     KC_K,    KC_L,     KC_SCLN, KC_QUOT,                    KC_ENT,  KC_PGUP, \
    _______, _______, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,     KC_M,     KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,                    KC_UP,   KC_PGDN, \
    _______, _______, KC_LCTL, KC_LALT, KC_LGUI, MO(_FN1),KC_SPC,           MO(_FN2), KC_RCTRL, KC_RGUI, MO(_FN3), _______, KC_LEFT,                    KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, _______, _______, M_EMOJ,  M_ALFR,  _______, _______,  _______,  _______, _______,  KC_MPLY, KC_MRWD, KC_MFFD, _______,  _______, \
    _______, _______, _______, KC_LALT, KC_LSFT, KC_LGUI, _______, _______, KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT,  M_GDIFF, _______, _______, _______,  \
